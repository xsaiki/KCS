    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-kcsBlue">Parent Portal Login</h2>
          <p className="text-gray-500 text-sm mt-2">Access your dashboard and application status</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-sm text-kcsBlue hover:underline font-medium">
              Forgot Password?
            </Link>
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link to="/register" className="text-kcsBlue font-semibold hover:underline">Register here</Link>
        </p>
      </div>
    </div>
  );
